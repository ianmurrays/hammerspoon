...
| `mouse_grid` | Keyboard-driven mouse (Mouseless-style): full-screen hint grid + in-cell subgrid for click/right/double click, drag & drop, scroll mode; canvas cached per screen, modal eventtap while overlay is up | Tap left Cmd |
